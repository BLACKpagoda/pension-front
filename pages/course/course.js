...
Page({
  ...
  requestData() {
    ...
    const article = courseModel.getArtCourse(this.data.page, this.data.tagData);
    const video = courseModel.getVideoCourse(this.data.page, this.data.tagData);
  ...
  onReachBottom: function () {
    ...
    setTimeout(() => {
      if (this.data.flag) {
        this._lock();
        courseModel.getArtCourse(this.data.page, this.data.tagData)
          .then((res) => {
        ...
        if (this.data.videoFlag) {
          courseModel.getVideoCourse(this.data.page, this.data.tagData)
            .then((res) => {
              if (res.length < 2) {
                this._vidoeLock()
